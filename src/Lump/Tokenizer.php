...
class Tokenizer
{
     ...
     *
     * @throws Exceptions\SyntaxException when mismatched section tags are encountered
     *
     * @param string $text       lump template source to tokenize
     * @param string $delimiters Optionally, pass initial opening and closing delimiters (default: null)
     *
     * @return array Set of lump tokens
     */
    ...
    /**
     * Change the current lump delimiters. Set new `otag` and `ctag` values.
     *
     * @param string $text  lump template source
    ...
    /**
     * Set the current lump `otag` and `ctag` delimiters.
     *
