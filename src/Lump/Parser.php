...
class Parser
{
    ...
    /**
     * Process an array of lump tokens and convert them into a parse tree.
     *
     * @param array $tokens Set of lump tokens
     *
     * @return array lump token parse tree
     */
    public function parse(array $tokens = array())
    {
        ...
        $this->pragmaFilters = isset($this->pragmas[Lump::PRAGMA_FILTERS]);
        $this->pragmaBlocks  = isset($this->pragmas[Lump::PRAGMA_BLOCKS]);
     ...
     *
     * @throws Exceptions\SyntaxException when nesting errors or mismatched section tags are encountered
     *
     * @param array &$tokens Set of lump tokens
    ...
    private function buildTree(array &$tokens, array $parent = null)
    {
            ...
            switch ($token[Tokenizer::TYPE])
            {
                ...
                case Tokenizer::T_END_SECTION:
                    if (!isset($parent))
                    {
                        ...
                        throw new Exceptions\SyntaxException($msg, $token);
                    }
        ...
        if (isset($parent))
        {
            ...
            throw new Exceptions\SyntaxException($msg, $parent);
        }
     ...
     *
     * @throws Exceptions\SyntaxException if an invalid token is found inside a parent tag
     *
    ...
    private function checkIfTokenIsAllowedInParent($parent, array $token)
    {
        if ($parent[Tokenizer::TYPE] === Tokenizer::T_PARENT)
        {
            throw new Exceptions\SyntaxException('Illegal content in < parent tag', $token);
        }
    }
    ...
    private function enablePragma($name)
    {
        ...
        switch ($name)
        {
            case Lump::PRAGMA_BLOCKS:
                $this->pragmaBlocks = true;
                break;

            case Lump::PRAGMA_FILTERS:
