...
class Context
{
    ...
    /**
     * lump rendering Context constructor.
     *
     ...
     *     );
     *
     * ... and the lump following template:
     *
     *     {{ child.name }}
     *
     ...
     * @see Context::findDot
     *
     * @throws Exceptions\InvalidArgumentException if given an invalid anchored dot $id
     *
     * @param string $id Dotted variable selector
     *
     * @return mixed Variable value, or '' if not found
    ...
    public function findAnchoredDot($id)
    {
        ...
        if ($first !== '')
        {
            throw new Exceptions\InvalidArgumentException(sprintf('Unexpected id for findAnchoredDot: %s', $id));
        }
